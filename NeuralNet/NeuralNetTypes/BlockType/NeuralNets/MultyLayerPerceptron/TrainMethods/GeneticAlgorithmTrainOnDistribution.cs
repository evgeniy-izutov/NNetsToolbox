...
namespace NeuralNet.MultyLayerPerceptron {
	public sealed class GeneticAlgorithmTrainOnDistribution : TrainMethod {
		...
		public GeneticAlgorithmTrainOnDistribution (int populationSzie, INormalizeMethod normilazeMethod, float[] distribution, IList<TrainPair> trainingData) {
        ...
        private static void GetChromosomesStructure (MultyLayerPerceptron neuralNet, out int[] chromosomesStructure, out float[] minValues, out float[] maxValues) {
