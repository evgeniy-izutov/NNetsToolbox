...
namespace NeuralNet.RestrictedBoltzmannMachine {
	public class ClassificationRbmTrainMethod : TrainMethod {
		...
		public ClassificationRbmTrainMethod(IList<TrainPair> trainData, int methodStepsCount) {
			_methodStepsCount = methodStepsCount;
			_trainDataIterator = new RandomAccessIterator<TrainPair>(trainData);
		}

		public ClassificationRbmTrainMethod(IList<TrainPair> trainData, IList<TrainPair> testData, int methodStepsCount) {
			_trainDataIterator = new RandomAccessIterator<TrainPair>(trainData);
			_testData = testData;
			_methodStepsCount = methodStepsCount;
		}
